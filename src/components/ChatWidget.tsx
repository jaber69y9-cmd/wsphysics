...
const ChatWidget = () => {
  ...
  const [messages, setMessages] = useState<{role: 'user' | 'model', text: string}[]>([
    { role: 'model', text: `Hello! How can I help you with ${settings.site_name || "W'S Physics"} today?` }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: userMsg,
        config: {
          systemInstruction: `You are a helpful assistant for ${settings.site_name || "W'S Physics"}, an educational platform for HSC and Admission candidates in Bangladesh. Answer questions briefly and politely.`,
        }
      });
          ...
          >
            ...
            <div className="bg-gradient-to-r from-orange-600 to-red-600 p-4 text-white flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold">{settings.site_name || "W'S Physics"} Support</span>
              </div>

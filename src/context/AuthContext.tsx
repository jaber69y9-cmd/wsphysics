      ...
      if (firebaseUser) {
        try {
          ...
          if (userDoc.exists()) {
            ...
            if (userData.role === 'student' && (userData as any).status !== 'approved' && (userData as any).status !== 'active' && firebaseUser.email !== 'wsphysics@gmail.com') {
            ...
            if (firebaseUser.email === 'wsphysics@gmail.com') {

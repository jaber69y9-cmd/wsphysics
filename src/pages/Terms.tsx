      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <section className="space-y-4">
            ...
            <p>
              By accessing and using {settings.site_name || "WS Physics"}, you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, you must not use our services.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              We reserve the right to suspend or terminate your account if you violate these terms or engage in any behavior that harms the {settings.site_name || "WS Physics"} community.
            </p>
          </section>
